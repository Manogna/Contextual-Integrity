...
def about_press():                        # Action for 'About' button (2nd window)
    ...
    L5 = Label(about_win, text=" ", font=("Helvetica", 12), underline=0)
    L5.grid(row=4, column=0,)

    L6 = Label(about_win, text="Version:", font=("Helvetica", 12), underline=0)
    L6.grid(row=5, column=0,)

    L2_ = Label(about_win, text="Manogna Sunkara", font=("Helvetica", 12))
    L2_.grid(row=1, column=1, padx=0, pady=3)
    
    L3_ = Label(about_win, text="Manogna.sunkara", font=("Helvetica", 12))
    L3_.grid(row=2, column=1, padx=0, pady=3)

    L4_ = Label(about_win, text="manogna.sunkara@gmail.com", font=("Helvetica", 12))
